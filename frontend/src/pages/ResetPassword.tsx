      ...
      <div className="min-h-screen flex items-center justify-center bg-[#0a0a0a] px-4 py-12">
        <Card className="w-full max-w-md glass border-white/10">
          <CardHeader>
            ...
            <CardDescription className="text-gray-400">Le lien de réinitialisation est manquant ou invalide</CardDescription>
          </CardHeader>
          <CardFooter>
            <Link to="/forgot-password" className="w-full">
              <Button className="w-full bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700">Demander un nouveau lien</Button>
            </Link>
          </CardFooter>
        </Card>
      </div>
          ...
          <CardContent className="space-y-5">
            <div className="bg-green-500/10 border-2 border-green-500/30 rounded-lg p-6 animate-fade-in">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="font-semibold text-green-300">Mot de passe réinitialisé !</h3>
              </div>
